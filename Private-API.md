The private API contains class member that are not defined as `public` and are available via the Hooks classes. Members documented in this section don't belong to the Dev API.  
