The public API contains class member that are absolutely safe to use. When one of these functions change without being compatible with previous version of Gustav, a new major version is released.  
